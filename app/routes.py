...
jhat_view = CRUDView.as_view('jha_view', model=JobHazardAnalysisTask, schema=JobHazardAnalysisTaskSchema)
...
jhath_view = CRUDView.as_view('jha_view', model=JobHazardAnalysisTaskHazard, schema=JobHazardAnalysisTaskHazardSchema)
...
jhatc_view = CRUDView.as_view('jha_view', model=JobHazardAnalysisTaskConsequences, schema=JobHazardAnalysisTaskConsequencesSchema)
...
jhatpm_view = CRUDView.as_view('jha_view', model=JobHazardAnalysisPreventativeMeasure, schema=JobHazardAnalysisPreventativeMeasureSchema)
