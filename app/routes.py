...
jhat_view = CRUDView.as_view('jhat_view', model=JobHazardAnalysisTask, schema=JobHazardAnalysisTaskSchema)
...
jhath_view = CRUDView.as_view('jhath_view', model=JobHazardAnalysisTaskHazard, schema=JobHazardAnalysisTaskHazardSchema)
...
jhatc_view = CRUDView.as_view('jhatc_view', model=JobHazardAnalysisTaskConsequences, schema=JobHazardAnalysisTaskConsequencesSchema)
...
jhatpm_view = CRUDView.as_view('jhatpm_view', model=JobHazardAnalysisPreventativeMeasure, schema=JobHazardAnalysisPreventativeMeasureSchema)
